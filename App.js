  ...
  return (
    <View style={styles.container}>
      <View style={styles.result}>
        <Text style={styles.resultText}> {lastNumber} {number} </Text>
      </View>
      <View style={styles.buttons}>
        <View style={styles.numbers}>
          {buttonNumbers.map((item) =>
            <TouchableOpacity key={item} style={styles.numberButton} onPress={() => result(item)}>
        ...
        <View style={styles.operators}>
          {buttonOperator.map((item) =>
            <TouchableOpacity key={item} style={styles.operatorButton} onPress={() => result(item)}>
